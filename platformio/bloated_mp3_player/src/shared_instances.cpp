...
* LAST Modified: 21:30:59 17-07-2026
* DESCRIPTION:
...
namespace SharedInstances
{
    ...
    Adafruit_NeoPixel onboard(1, My::Config::Pins::ONBOARD_LED_PIN, NEO_GRB + NEO_KHZ800);
    My::Serial serial(SERIAL_MSG_LEN, SERIAL_QUEUE_LEN);
}
