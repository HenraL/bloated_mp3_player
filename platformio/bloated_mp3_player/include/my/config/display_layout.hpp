...
* LAST Modified: 22:40:57 22-07-2026
* DESCRIPTION:
...
namespace My
{
    namespace Config
    {
        namespace DisplayLayout
        {
            ...
            static const int16_t         TEMPERATURE_Y = 10;

            // Humidity position
            static const int16_t            HUMIDITY_X = 45;
            static const int16_t            HUMIDITY_Y = 10;

            // Pressure position
            static const int16_t            PRESSURE_X = 72;
            static const int16_t            PRESSURE_Y = 10;
