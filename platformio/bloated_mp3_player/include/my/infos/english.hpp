...
namespace My
{
    namespace Infos
    {
        namespace UART
        {
            ...
            static const char bt_bridge_ready[] = "[BT] BLE UART bridge online -- debug feed mirrored";
            static const char bt_bridge_fail[] = "WARN: BLE UART bridge failed to start";
            ...
            static const char char_lcd_task_start[] = "[CHAR] Info panel is running on its own task.";
        ...
        namespace LCD
        {
            ...
            static const char boot_motto[] = "DON'T PANIC";
            static const char booting_i2c[] = "Booting: I2C...";
            static const char i2c_ok[] = "I2C sensors: OK";
            static const char i2c_fail[] = "I2C sensors: FAIL";
            static const char booting_sd[] = "Booting: SD...";
            static const char sd_missing[] = "SD card: MISSING";
            static const char sd_no_music[] = "SD card: no music";
            static const char sd_tracks[] = "SD: %lu tracks";
            static const char booting_audio[] = "Booting: audio...";
            static const char audio_ok[] = "Audio I2S: OK";
            static const char audio_fail[] = "Audio I2S: FAIL";
            static const char track_press_play[] = "Track %lu/%lu press=play";
            static const char sel_press_enter[] = "Sel %lu/%lu press=enter";
            static const char no_track[] = "No track";
            static const char no_sensor[] = "No sensor data";
            static const char vogon_title[] = "VOGON POETRY";
            static const char vogon_tilt[] = "Tilt R:%5.1f P:%5.1f";
            static const char vogon_yaw[] = "Yaw %5.1f";
        } // namespace LCD
    } // namespace Infos
} // namespace My