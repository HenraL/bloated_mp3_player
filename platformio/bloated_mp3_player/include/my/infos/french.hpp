...
namespace My
{
    namespace Infos
    {
        namespace UART
        {
            ...
            // ─── Bluetooth (pont UART BLE) ────────────────────────────────────────────
            static const char bt_bridge_ready[] = "[BT] Pont UART BLE en ligne -- flux de débogage dupliqué";
            static const char bt_bridge_fail[] = "WARN: échec du démarrage du pont UART BLE";
            ...
            static const char sensor_orientation[] = "[Sensor] Roulis: %.1f Tangage: %.1f Lacet: %.1f";
            ...
            static const char input_ultrasonic_double_waved[] = "[INPUT] Double vague ultrason, retour au menu.";
            static const char input_going_back_to_menu[] = "[INPUT] Menu (parcours des albums).";
            ...
            static const char input_select_start[] = "[INPUT] Parcours des pistes : tournez pour choisir, appuyez pour jouer.";
            static const char input_select_moved[] = "[INPUT] Sélection : %lu/%lu";
            static const char input_select_play[] = "[INPUT] Lecture de la piste sélectionnée %lu.";
        ...
        namespace LCD
        {
            ...
            static const char boot_motto[] = "PAS DE PANIQUE";
            static const char booting_i2c[] = "Demarrage: I2C...";
            static const char i2c_ok[] = "Capteurs I2C: OK";
            static const char i2c_fail[] = "Capteurs I2C: ERREUR";
            static const char booting_sd[] = "Demarrage: SD...";
            static const char sd_missing[] = "Carte SD: ABSENTE";
            static const char sd_no_music[] = "SD: aucune musique";
            static const char sd_tracks[] = "SD: %lu pistes";
            static const char booting_audio[] = "Demarrage: audio...";
            static const char audio_ok[] = "Audio I2S: OK";
            static const char audio_fail[] = "Audio I2S: ERREUR";
            static const char track_press_play[] = "Piste %lu/%lu=play";
            static const char sel_press_enter[] = "Alb %lu/%lu=entree";
            static const char no_track[] = "Pas de piste";
            static const char no_sensor[] = "Pas de capteurs";
            static const char vogon_title[] = "POESIE VOGON";
            static const char vogon_tilt[] = "Incl R:%5.1f P:%5.1f";
            static const char vogon_yaw[] = "Lacet %5.1f";
        } // namespace LCD
    } // namespace Infos
} // namespace My