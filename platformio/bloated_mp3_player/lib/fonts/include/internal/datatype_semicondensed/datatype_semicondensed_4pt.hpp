...
#define DATATYPE_SEMICONDENSED_4PT_WIDTH  3
#define DATATYPE_SEMICONDENSED_4PT_HEIGHT 5
#define DATATYPE_SEMICONDENSED_4PT_FIRST  32
#define DATATYPE_SEMICONDENSED_4PT_LAST   8722
#define DATATYPE_SEMICONDENSED_4PT_COUNT  319

extern const uint16_t datatype_semicondensed_4pt_codes[];
