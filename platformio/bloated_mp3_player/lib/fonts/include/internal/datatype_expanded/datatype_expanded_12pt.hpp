...
static const uint8_t DATATYPE_EXPANDED_12PT_WIDTH  = 8;
static const uint8_t DATATYPE_EXPANDED_12PT_HEIGHT = 24;
static const uint8_t DATATYPE_EXPANDED_12PT_ASCENT = 12;
static const uint32_t DATATYPE_EXPANDED_12PT_FIRST  = 32;
static const uint32_t DATATYPE_EXPANDED_12PT_LAST   = 8722;
static const uint16_t DATATYPE_EXPANDED_12PT_COUNT  = 319;

extern const uint32_t datatype_expanded_12pt_codes[];
...
extern const FontHandle datatype_expanded_12pt_handle;
