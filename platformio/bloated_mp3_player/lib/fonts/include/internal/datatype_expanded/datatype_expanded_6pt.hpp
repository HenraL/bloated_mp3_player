...
#define DATATYPE_EXPANDED_6PT_WIDTH  4
#define DATATYPE_EXPANDED_6PT_HEIGHT 7
#define DATATYPE_EXPANDED_6PT_FIRST  32
#define DATATYPE_EXPANDED_6PT_LAST   8722
#define DATATYPE_EXPANDED_6PT_COUNT  319

extern const uint16_t datatype_expanded_6pt_codes[];
