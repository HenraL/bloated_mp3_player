...
#define DATATYPE_EXPANDED_2PT_WIDTH  2
#define DATATYPE_EXPANDED_2PT_HEIGHT 3
#define DATATYPE_EXPANDED_2PT_FIRST  32
#define DATATYPE_EXPANDED_2PT_LAST   8722
#define DATATYPE_EXPANDED_2PT_COUNT  319

extern const uint16_t datatype_expanded_2pt_codes[];
