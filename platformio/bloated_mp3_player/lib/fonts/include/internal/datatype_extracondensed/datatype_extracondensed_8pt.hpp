...
static const uint8_t DATATYPE_EXTRACONDENSED_8PT_WIDTH  = 6;
static const uint8_t DATATYPE_EXTRACONDENSED_8PT_HEIGHT = 18;
static const uint8_t DATATYPE_EXTRACONDENSED_8PT_ASCENT = 8;
static const uint32_t DATATYPE_EXTRACONDENSED_8PT_FIRST  = 32;
static const uint32_t DATATYPE_EXTRACONDENSED_8PT_LAST   = 8722;
static const uint16_t DATATYPE_EXTRACONDENSED_8PT_COUNT  = 319;

extern const uint32_t datatype_extracondensed_8pt_codes[];
...
extern const FontHandle datatype_extracondensed_8pt_handle;
