...
#define BITCOUNTSINGLE_CURSIVE_4PT_WIDTH  5
#define BITCOUNTSINGLE_CURSIVE_4PT_HEIGHT 5
#define BITCOUNTSINGLE_CURSIVE_4PT_FIRST  32
#define BITCOUNTSINGLE_CURSIVE_4PT_LAST   64258
#define BITCOUNTSINGLE_CURSIVE_4PT_COUNT  396

extern const uint16_t bitcountsingle_cursive_4pt_codes[];
