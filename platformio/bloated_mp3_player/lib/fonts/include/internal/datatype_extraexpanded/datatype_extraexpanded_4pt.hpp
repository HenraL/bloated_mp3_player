...
static const uint8_t DATATYPE_EXTRAEXPANDED_4PT_WIDTH  = 3;
static const uint8_t DATATYPE_EXTRAEXPANDED_4PT_HEIGHT = 12;
static const uint8_t DATATYPE_EXTRAEXPANDED_4PT_ASCENT = 4;
static const uint32_t DATATYPE_EXTRAEXPANDED_4PT_FIRST  = 32;
static const uint32_t DATATYPE_EXTRAEXPANDED_4PT_LAST   = 8722;
static const uint16_t DATATYPE_EXTRAEXPANDED_4PT_COUNT  = 319;

extern const uint32_t datatype_extraexpanded_4pt_codes[];
...
extern const FontHandle datatype_extraexpanded_4pt_handle;
