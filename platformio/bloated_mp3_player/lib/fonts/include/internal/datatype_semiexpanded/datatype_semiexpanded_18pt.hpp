...
static const uint8_t DATATYPE_SEMIEXPANDED_18PT_WIDTH  = 12;
static const uint8_t DATATYPE_SEMIEXPANDED_18PT_HEIGHT = 38;
static const uint8_t DATATYPE_SEMIEXPANDED_18PT_ASCENT = 18;
static const uint32_t DATATYPE_SEMIEXPANDED_18PT_FIRST  = 32;
static const uint32_t DATATYPE_SEMIEXPANDED_18PT_LAST   = 8722;
static const uint16_t DATATYPE_SEMIEXPANDED_18PT_COUNT  = 319;

extern const uint32_t datatype_semiexpanded_18pt_codes[];
...
extern const FontHandle datatype_semiexpanded_18pt_handle;
