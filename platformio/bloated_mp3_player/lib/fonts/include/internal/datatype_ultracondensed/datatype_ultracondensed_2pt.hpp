...
static const uint8_t DATATYPE_ULTRACONDENSED_2PT_WIDTH  = 2;
static const uint8_t DATATYPE_ULTRACONDENSED_2PT_HEIGHT = 6;
static const uint8_t DATATYPE_ULTRACONDENSED_2PT_ASCENT = 2;
static const uint32_t DATATYPE_ULTRACONDENSED_2PT_FIRST  = 32;
static const uint32_t DATATYPE_ULTRACONDENSED_2PT_LAST   = 8722;
static const uint16_t DATATYPE_ULTRACONDENSED_2PT_COUNT  = 319;

extern const uint32_t datatype_ultracondensed_2pt_codes[];
...
extern const FontHandle datatype_ultracondensed_2pt_handle;
